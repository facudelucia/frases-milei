    ...
    return (
        <div className="audio">
            <div class="audio__container">
              <div class="audio__progress" id="progress"></div>
              <audio onPlaying={handlePlaying} onPause={handlePause} id="audio" src={audio1}></audio>
              <button class="togglePlay" onClick={()=>togglePlay()}>Play/Pause</button>
              <button class="togglePlay1"><a href={audio1} download><GetAppIcon /></a></button>
            </div>
        </div>
    )
}
