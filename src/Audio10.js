...
var advance = function(duration, element) {
  var progress = document.getElementById("progress10");
    ...
    return (
        <div className="audio">
            <div class="audio__container">
              <div class="audio__progress" id="progress10"></div>
              <audio onPlaying={handlePlaying} onPause={handlePause} id="audio10" src={audio10}></audio>
              <button class="togglePlay" onClick={()=>togglePlay()}>Play/Pause</button>
              <button class="togglePlay1"><a href={audio10} download><GetAppIcon /></a></button>
            </div>
        </div>
    )
}

export default Audio10
