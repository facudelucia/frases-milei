...
var advance = function(duration, element) {
  var progress = document.getElementById("progress11");
    ...
    return (
        <div className="audio">
            <div class="audio__container">
              <div class="audio__progress" id="progress11"></div>
              <audio onPlaying={handlePlaying} onPause={handlePause} id="audio11" src={audio11}></audio>
              <button class="togglePlay" onClick={()=>togglePlay()}>Play/Pause</button>
              <button class="togglePlay1"><a href={audio11} download><GetAppIcon /></a></button>
            </div>
        </div>
    )
}

export default Audio11
