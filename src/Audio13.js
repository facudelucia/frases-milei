...
var advance = function(duration, element) {
  var progress = document.getElementById("progress13");
    ...
    return (
        <div className="audio">
            <div class="audio__container">
              <div class="audio__progress" id="progress13"></div>
              <audio onPlaying={handlePlaying} onPause={handlePause} id="audio13" src={audio13}></audio>
              <button class="togglePlay" onClick={()=>togglePlay()}>Play/Pause</button>
              <button class="togglePlay1"><a href={audio13} download><GetAppIcon /></a></button>
            </div>
        </div>
    )
}

export default Audio13
