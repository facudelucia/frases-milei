...
var advance = function(duration, element) {
  var progress = document.getElementById("progress15");
    ...
    return (
        <div className="audio">
            <div class="audio__container">
              <div class="audio__progress" id="progress15"></div>
              <audio onPlaying={handlePlaying} onPause={handlePause} id="audio15" src={audio15}></audio>
              <button class="togglePlay" onClick={()=>togglePlay()}>Play/Pause</button>
              <button class="togglePlay1"><a href={audio15} download><GetAppIcon /></a></button>
            </div>
        </div>
    )
}

export default Audio15
