...
var advance = function(duration, element) {
  var progress = document.getElementById("progress19");
    ...
    return (
        <div className="audio">
            <div class="audio__container">
              <div class="audio__progress" id="progress19"></div>
              <audio onPlaying={handlePlaying} onPause={handlePause} id="audio19" src={audio19}></audio>
              <button class="togglePlay" onClick={()=>togglePlay()}>Play/Pause</button>
              <button class="togglePlay1"><a href={audio19} download><GetAppIcon /></a></button>
            </div>
        </div>
    )
}

export default Audio19
