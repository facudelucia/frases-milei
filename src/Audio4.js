    ...
    return (
        <div className="audio">
            <div class="audio__container">
              <div class="audio__progress" id="progress4"></div>
              <audio onPlaying={handlePlaying} onPause={handlePause} id="audio4" src={audio4}></audio>
              <button class="togglePlay" onClick={()=>togglePlay()}>Play/Pause</button>
              <button class="togglePlay1"><a href={audio4} download><GetAppIcon /></a></button>
            </div>
        </div>
    )
}
