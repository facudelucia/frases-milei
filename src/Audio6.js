...
var advance = function(duration, element) {
  var progress = document.getElementById("progress6");
    ...
    return (
        <div className="audio">
            <div class="audio__container">
              <div class="audio__progress" id="progress6"></div>
              <audio onPlaying={handlePlaying} onPause={handlePause} id="audio6" src={audio6}></audio>
              <button class="togglePlay" onClick={()=>togglePlay()}>Play/Pause</button>
              <button class="togglePlay1"><a href={audio6} download><GetAppIcon /></a></button>
            </div>
        </div>
    )
}
