...
var advance = function(duration, element) {
  var progress = document.getElementById("progress9");
    ...
    return (
        <div className="audio">
            <div class="audio__container">
              <div class="audio__progress" id="progress9"></div>
              <audio onPlaying={handlePlaying} onPause={handlePause} id="audio9" src={audio9}></audio>
              <button class="togglePlay" onClick={()=>togglePlay()}>Play/Pause</button>
              <button class="togglePlay1"><a href={audio9} download><GetAppIcon /></a></button>
            </div>
        </div>
    )
}

export default Audio9
